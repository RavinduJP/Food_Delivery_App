...
import 'package:food_delivery_app/common/icon_and_text_widget.dart';
      ...
      children: [
        ...
        ListView.builder(
            ...
            itemBuilder: (context, index) {
              return Container(
                margin: EdgeInsets.only(left: Dimensions.width15, right: Dimensions.width15, bottom: Dimensions.height5),
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                fit: BoxFit.cover,
                image: AssetImage("assets/images/chineseFood.jpg"),
              ),
            ),
          ),
          Align(
